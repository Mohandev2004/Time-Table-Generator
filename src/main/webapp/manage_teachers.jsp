<%@ page import="com.timetable.model.Teacher, java.util.List" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="col-md-2 sidebar d-none d-md-block">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active fw-bold text-white" href="teachers"><i class="fas fa-chalkboard-teacher me-2"></i> Teachers</a></li>
                            ...
                            <table class="table table-hover mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= t.getEmail() %></td>
                                        <td>
                                            <a href="teachers?action=delete&id=<%= t.getId() %>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this teacher?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <% 
                                            }
